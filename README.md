...
documentacion 
el programa remal le modifique la cantidad de produsctos vendidos para que me de un total exacto y cambie algunas variables para que el programa sea mas claro 